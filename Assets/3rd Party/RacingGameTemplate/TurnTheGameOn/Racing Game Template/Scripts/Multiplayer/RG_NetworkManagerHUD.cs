...
namespace UnityEngine.Networking{
	...
	public class RG_NetworkManagerHUD : NetworkBehaviour	{
		...
		void UpdateMatchInfo(){
			...
			networkLobbyManager.matchMaker.ListMatches(0,20, "", true, 0, 0, networkLobbyManager.OnMatchList);
		...
		void InternetMatch(){
			...
			networkLobbyManager.matchMaker.CreateMatch (networkLobbyManager.matchName, networkLobbyManager.matchSize, true, "", "", "", 0, 0, new NetworkMatch.DataResponseDelegate<MatchInfo>(networkLobbyManager.OnMatchCreate));
	...
	//	}
		...
		public virtual void MatchJoined(bool success, string extendedInfo, MatchInfo matchInfo){
			if(LogFilter.logDebug){
			...
			if (success) {
				...
				networkLobbyManager.StartClient (matchInfo);
			}
		...
		public void JoinMatch(int i){
			...
			networkLobbyManager.matchMaker.JoinMatch(networkId, "", "", "", 0, 0, new NetworkMatch.DataResponseDelegate<MatchInfo>(MatchJoined));
